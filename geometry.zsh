...
GEOMETRY_COLOR_USER=${GEOMETRY_COLOR_USER:-yellow}
GEOMETRY_COLOR_HOST=${GEOMETRY_COLOR_HOST:-green}
GEOMETRY_COLOR_RESET=${GEOMETRY_COLOR_RESET:-white}
...
prompt_geometry_render() {
  ...
  PROMPT=" %${#PROMPT_SYMBOL}{%(?.$GEOMETRY_PROMPT.$GEOMETRY_EXIT_VALUE)%} %F{$GEOMETRY_COLOR_USER}%n%F{$GEOMETRY_COLOR_RESET}@%F{$GEOMETRY_COLOR_HOST}%m: %F{$GEOMETRY_COLOR_DIR}%3~%f $GEOMETRY_PROMPT_PREFIX %% "
